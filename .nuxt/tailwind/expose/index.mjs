...
const config = { theme, corePlugins, plugins, darkMode, content, safelist, variants, presets, prefix, important, separator, blocklist }
export { config as default, theme, corePlugins, plugins, darkMode, content, safelist, variants, presets, prefix, important, separator, blocklist }