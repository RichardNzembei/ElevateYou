...
const __nuxt_page_meta$4 = { layout: "dashboard", middleware: "auth", ssr: false };
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/Dashboard-D7TjibIj.js")
  },
  {
    name: "forgot-password",
    path: "/forgot-password",
    meta: __nuxt_page_meta$3,
    component: () => import("./_nuxt/forgot-password-Dxy_zQr6.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$2,
    component: () => import("./_nuxt/index-ChaGRVW7.js")
  },
  {
    name: "Login",
    path: "/Login",
    meta: __nuxt_page_meta$1,
    component: () => import("./_nuxt/Login-BHSwJ5f4.js")
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta,
    component: () => import("./_nuxt/register-BIYwbpOI.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-DyfQQo5-.js")
};
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-Cj7uHV8c.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  ...
  default: defineAsyncComponent(() => import("./_nuxt/default-DJXM21Wb.js").then((m) => m.default || m))
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      title: "ElevateYou - Open Source Project Management",
      meta: [
        { name: "description", content: "Free, open source project management platform. Track tasks, collaborate on docs, and organize your work in real-time." }
      ],
      link: [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B0L2u-mk.js"));
