...
import { FieldValue } from 'file:///home/reuben/.Documents/ElevateYou-1/node_modules/firebase-admin/lib/esm/firestore/index.js';
import multiparty from 'file:///home/reuben/.Documents/ElevateYou-1/node_modules/multiparty/index.js';
import fs from 'fs/promises';
import admin from 'file:///home/reuben/.Documents/ElevateYou-1/node_modules/firebase-admin/lib/index.js';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "recaptchaSiteKey": "6LeTeyArAAAAALU12UL5xAfq6YwqQciprXAXuRSo"
  },
  "icon": {
...
const _lazy_QW2iV1 = () => Promise.resolve().then(function () { return fertilizerRecords$1; });
const _lazy_5DCcUL = () => Promise.resolve().then(function () { return harvestRecords$1; });
const _lazy_vFUtzj = () => Promise.resolve().then(function () { return laborRecord$1; });
const _lazy_4MWOeN = () => Promise.resolve().then(function () { return landPrepRecords$1; });
const _lazy_wsvZoG = () => Promise.resolve().then(function () { return progressRecords$1; });
const _lazy_6mTouE = () => Promise.resolve().then(function () { return projects$1; });
const _lazy_p75lGM = () => Promise.resolve().then(function () { return sprayingRecords$1; });
const _lazy_pwRi9I = () => Promise.resolve().then(function () { return updateStatus$1; });
const _lazy_1vhWFz = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/fertilizerRecords', handler: _lazy_QW2iV1, lazy: true, middleware: false, method: undefined },
  { route: '/api/harvestRecords', handler: _lazy_5DCcUL, lazy: true, middleware: false, method: undefined },
  { route: '/api/laborRecord', handler: _lazy_vFUtzj, lazy: true, middleware: false, method: undefined },
  { route: '/api/landPrepRecords', handler: _lazy_4MWOeN, lazy: true, middleware: false, method: undefined },
  { route: '/api/progressRecords', handler: _lazy_wsvZoG, lazy: true, middleware: false, method: undefined },
  { route: '/api/projects', handler: _lazy_6mTouE, lazy: true, middleware: false, method: undefined },
  { route: '/api/sprayingRecords', handler: _lazy_p75lGM, lazy: true, middleware: false, method: undefined },
  { route: '/api/updateStatus', handler: _lazy_pwRi9I, lazy: true, middleware: false, method: undefined },
